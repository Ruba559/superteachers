                          ...
                          child: InkWell(
                             ...
                             Expanded(flex: 3, child: Container(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: radius20,
                                      child: Image.network(
                                        controller.educationalSubjects[index].file,
                                        height: 80,
                                        width: 80,
                                        fit: BoxFit.contain,
                                      ),
                              ...
                              Expanded(flex: 5, child:Text(
                                  controller.educationalSubjects[index].name,
                              
                                ), ) ,
                                   Expanded(flex: 2, child:
                                     InkWell(
                            onTap: ()  async {
                                print(controller.educationalSubjects[index].file);
                                               final Uri _url = Uri.parse(controller.educationalSubjects[index].file);
